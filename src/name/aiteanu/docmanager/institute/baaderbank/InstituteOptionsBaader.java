...
public class InstituteOptionsBaader {
	public static final String SHORT_NAME = "Baader Bank";
	public static final String LONG_NAME = "Baader Bank (Dokumente)";
	public static final String LOGIDENT = "[DocManager:Baader] ";
