...
public class DocDBServiceImpl extends HBCIDBServiceImpl
{
   ...
   */
  public DocDBServiceImpl() throws RemoteException
  {
   ...
   * @throws RemoteException
   */
  public DocDBServiceImpl(String driverClass) throws RemoteException
  {
    super();
      ...
      for (int i=0;i<10;++i)
      {
        ...
        if (t instanceof SQLException)
        {
          ...
          if (code == 90131)
          {
            ...
            throw new ApplicationException(i18n.tr("Bitte aktualisiere erst Jameica auf Version 2.8.2 oder hï¿½her"));
          }
        }
        t = t.getCause();
      }
...
//  }
  ...
  public void install() throws RemoteException
  {
    ...
    monitor.setStatusText(i18n.tr("Installiere DocManager"));
    
    Manifest mf = Application.getPluginLoader().getPlugin(DocManager.class).getManifest();
